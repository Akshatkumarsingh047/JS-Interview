// APPLY IS SAME AS CALL . ONLY THE ARGS AE PASSED IN ARRAY


Function.prototype.myApply=function(context,args){

    //IMPORTANT CHECK FOR APPLY
    if(!Array.isArray(args))
    {
        console.error("The Arguments must be an array")
        return;
    }
...
getEmployeeInfo.myApply(employee1, ['Engineering Manager', 'Dell']);
